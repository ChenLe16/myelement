...
def display_pillars_table(result):
    ...
    <style>
        .pillar-table-dark {
            width:87%; margin:auto; border-radius:13px; box-shadow:0 1px 12px #23272e;
            background:#23262c;
        }
        ...
        .pillar-table-dark tr { transition: background 0.22s; }
        .pillar-table-dark tr:hover { background:#222c24 !important; }
...
def display_element_star_meter(result):
    ...
    .star-meter-table-dark tr { transition: background 0.18s; }
    .star-meter-table-dark tr:hover { background: #242d34 !important; }
