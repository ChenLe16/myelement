...
def display_pillars_table(result):
    ...
    strength_color = "#fab74b" if "Strong" in verdict else "#44c4fa"
    ...
    color = "#fab74b" if verdict == "Strong" else "#44c4fa"
    table += f"""
        <tr>
            <td colspan="4" class="strength-row">
                Day Master Strength: <span style="color:{color};">{verdict}</span>
            </td>
        </tr>
    """
    table += "</table>"
